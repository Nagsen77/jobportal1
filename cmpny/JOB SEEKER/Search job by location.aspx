<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Search job by location.aspx.cs" Inherits="Default2" Theme="Theme2" %>
        ...
        <ul id="menu">
            ...
            <li class="last">
                ...
                <asp:HoverMenuExtender ID="HyperLink5_HoverMenuExtender" runat="server" 
                    ...
                    PopDelay="100" PopupPosition="Bottom"></asp:HoverMenuExtender>
            </li>
            <li class="last">
                ...
                Font-Size="Small" Font-Bold="True">Feedback</asp:LinkButton>
                                <asp:HoverMenuExtender ID="LinkButton1_HoverMenuExtender" runat="server" 
                                    ...
                                    PopupPosition="Bottom"></asp:HoverMenuExtender>
                                &nbsp;&nbsp;&nbsp;
                ...
                <table class="style1" style="border: thin solid #000000">
                    <tr>
                        ...
                        <td style="text-align: left">
                            ...
                            <br />
                            1.Select the Valid Location and Experience from tha DropDown List.(Remember both 
                            ...
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Large" 
                                Font-Underline="True" ForeColor="Maroon" Text="Search by Location:-"></asp:Label>
                                                    <br />
                                                    <br />
                                                <table class="style28" 
                                style="background-color: #644687; border: medium solid #000000">
                                                    <tr>
                                                        <td class="style30" bgcolor="#7D0000">
                                                        ...
                                                        <td class="style29" bgcolor="#7D0000">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:Job_SearchConnectionString14 %>"
                                
                                SelectCommand="SELECT [Company_name], [Industry], [Experience], [Company_Type], [Functional_Area], [Apply_here] FROM [Upload_Job] WHERE (([Job_Location] = @Job_Location) AND ([Experience] = @Experience))" >
                                <SelectParameters>
